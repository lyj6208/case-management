...
CREATE TABLE `teams` (
  ...
  CONSTRAINT `fk_department of teams` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `customers` (
  ...
  CONSTRAINT `fk_industry_category of customers` FOREIGN KEY (`industry_category_id`) REFERENCES `industry_categories` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_last_modified_by of customers` FOREIGN KEY (`last_modified_by_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `test_items` (
  ...
  `last_modified_time` timestamp NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  `last_modified_by_id` BIGINT DEFAULT NULL,
  `experiment_operator_id` BIGINT DEFAULT NULL,
  ...
  KEY `last_modified_by_id of testItem_idx` (`last_modified_by_id`),
  KEY `experiment_operator_id of testItem_idx` (`experiment_operator_id`),
  KEY `experiment_reviewer_id of testItem_idx` (`experiment_reviewer_id`),
  KEY `report_conductor_id of testItem_idx` (`report_conductor_id`),
  CONSTRAINT `fk_last_modified_by_id of testItem` FOREIGN KEY (`last_modified_by_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_experiment_operator_id of testItem` FOREIGN KEY (`experiment_operator_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_experiment_reviewer_id of testItem` FOREIGN KEY (`experiment_reviewer_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_report_conductor_id of testItem` FOREIGN KEY (`report_conductor_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
...
CREATE TABLE `test_cases` (
  ...
  KEY `experiment_operator_id of case_idx` (`experiment_operator_id`),
  ...
  CONSTRAINT `fk_experiment_operator_id of case` FOREIGN KEY (`experiment_operator_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
